function showPopup(popupId) {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    addPopupListeners("PopUpKrome", "KromeClose", "KromeOK");
    addPopupListeners("PopUpWeep", "WeepClose", "WeepOK");
    addPopupListeners("PopUpEncrypt", "EncryptClose", "EncryptOK");
    addPopupListeners("PopUpfourth", "fourthClose", "fourthOK");
    addPopupListeners("PopUpViral", "ViralClose", "ViralOK");
    addPopupListeners("PopUpCydist", "CydistClose", "CydistOK");
  });
